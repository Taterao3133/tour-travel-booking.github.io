          ...
          <Col lg='6'>
            <div className='hero__content'>
              <div className='hero__img d-flex align-items-center'>
                {/* <Subtitle title={'kmkkk'}/> */}
                <h5>Know Better Before You Go</h5>
    ...
    <Container>
      <Row>
        <Col lg='12' className='mb-5'> 
          <h1 className='services__subtitle'>Explore</h1>
   ...
   <section>
      ...
      <Row>
        <Col lg='6'>
          <div className='experience__content'>
            <h2 className='services__subtitle'>Experience..</h2>
    ...
    <section>
      <Container>
        <Row>
          <Col lg='12'>
            <h2 className='services__subtitle'>Gallery</h2>
